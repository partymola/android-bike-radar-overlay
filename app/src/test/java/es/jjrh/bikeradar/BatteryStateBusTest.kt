...
class BatteryStateBusTest {
    ...
    @Test fun markSeenBumpsReadAtMsOnExistingEntry() {
        BatteryStateBus.update(BatteryEntry("dashcam1", "Vue", 80, readAtMs = 1_000L, lastSeenElapsedMs = 1_000L))
    ...
    @Test fun markSeenPreservesNameAndPct() {
        BatteryStateBus.update(BatteryEntry("dashcam2", "My Vue", 42, readAtMs = 500L, lastSeenElapsedMs = 500L))
